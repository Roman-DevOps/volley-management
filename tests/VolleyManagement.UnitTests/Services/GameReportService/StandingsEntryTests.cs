...
namespace VolleyManagement.UnitTests.Services.GameReportService
{
    ...
    public class StandingsEntryTests
    {
        ...
        public void BallsRatio_HasWonAndLost_RatioIsCalculatedProperly()
        {
            ...
            actual.GetValueOrDefault().Should()
                .BeApproximately(expected, 0.001f, "Balls ratio should be properly calculated");
        }
        ...
        public void BallsRatio_HasWonButNoLost_RatioIsInfinity()
        {
            ...
            // Assert
            Assert.True(actual.HasValue, "Ratio should not be null");
            Assert.True(float.IsInfinity(actual.GetValueOrDefault()),
                "Balls ratio should be Infinity when there are no lost balls");
        }
        ...
        public void SetsRatio_HasWonAndLost_RatioIsCalculatedProperly()
        {
            ...
            Assert.True(actual.HasValue, "Ratio should not be null");
            actual.GetValueOrDefault().Should()
                .BeApproximately(expected, 0.001f, "Sets ratio should be properly calculated");
        }
        ...
        public void SetsRatio_HasWonButNoLost_RatioIsInfinity()
        {
            ...
            Assert.True(actual.HasValue, "Ratio should not be null");
            Assert.True(float.IsInfinity(actual.GetValueOrDefault()),
                "Sets ratio should be Infinity when there are no lost sets");
        }
