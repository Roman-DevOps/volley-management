...
namespace VolleyManagement.UnitTests.Services.RolesService
{
    ...
    public class RolesServiceTests
    {
        ...
        private readonly Mock<IQuery<ICollection<Role>, GetAllCriteria>> _getAllQueryMock;
        private readonly Mock<IQuery<Role, FindByIdCriteria>> _getByIdQueryMock;
        private readonly Mock<IQuery<List<UserInRoleDto>, FindByRoleCriteria>> _getUsersByRoleQueryMock;
        private readonly Mock<IQuery<List<UserInRoleDto>, GetAllCriteria>> _getUserInRolesQueryMock;
        ...
        private VolleyManagement.Services.Authorization.RolesService BuildSUT()
        {
            return new VolleyManagement.Services.Authorization.RolesService(
