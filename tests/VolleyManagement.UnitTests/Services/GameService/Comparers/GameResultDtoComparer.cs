...
namespace VolleyManagement.UnitTests.Services.GameService
{
    ...
    internal class GameResultDtoComparer : IComparer<GameResultDto>, IComparer
    {
        ...
        internal bool AreEqual(GameResultDto x, GameResultDto y)
        {
            ...
            y.Result.GameScore.Home.Should()
                .Be(x.Result.GameScore.Home, $"[Id:{x.Id}] Result.GameScore.Home should be equal.");
            y.Result.GameScore.Away.Should()
                .Be(x.Result.GameScore.Away, $"[Id:{x.Id}] Result.GameScore.Away should be equal.");
            y.Result.GameScore.IsTechnicalDefeat.Should().Be(x.Result.GameScore.IsTechnicalDefeat,
                $"[Id:{x.Id}] IsTechnicalDefeat should be equal.");
            y.Result.SetScores[0].Home.Should()
                .Be(x.Result.SetScores[0].Home, $"[Id:{x.Id}] SetScores[0].Home should be equal.");
            y.Result.SetScores[0].Away.Should()
                .Be(x.Result.SetScores[0].Away, $"[Id:{x.Id}] SetScores[0].Away should be equal.");
            ...
            y.Result.SetScores[1].Home.Should()
                .Be(x.Result.SetScores[1].Home, $"[Id:{x.Id}] SetScores[1].Home should be equal.");
            y.Result.SetScores[1].Away.Should()
                .Be(x.Result.SetScores[1].Away, $"[Id:{x.Id}] SetScores[1].Away should be equal.");
            ...
            y.Result.SetScores[2].Home.Should()
                .Be(x.Result.SetScores[2].Home, $"[Id:{x.Id}] SetScores[2].Home should be equal.");
            y.Result.SetScores[2].Away.Should()
                .Be(x.Result.SetScores[2].Away, $"[Id:{x.Id}] SetScores[2].Away should be equal.");
            y.Result.SetScores[2].IsTechnicalDefeat.Should().Be(x.Result.SetScores[2].IsTechnicalDefeat,
                $"[Id:{x.Id}] SetScores[2].IsTechnicalDefeat should be equal.");
            y.Result.SetScores[3].Home.Should()
                .Be(x.Result.SetScores[3].Home, $"[Id:{x.Id}] SetScores[3].Home should be equal.");
            y.Result.SetScores[3].Away.Should()
                .Be(x.Result.SetScores[3].Away, $"[Id:{x.Id}] SetScores[3].Away should be equal.");
            y.Result.SetScores[3].IsTechnicalDefeat.Should().Be(x.Result.SetScores[3].IsTechnicalDefeat,
                $"[Id:{x.Id}] SetScores[3].IsTechnicalDefeat should be equal.");
            y.Result.SetScores[4].Home.Should()
                .Be(x.Result.SetScores[4].Home, $"[Id:{x.Id}] SetScores[4].Home should be equal.");
            y.Result.SetScores[4].Away.Should()
                .Be(x.Result.SetScores[4].Away, $"[Id:{x.Id}] SetScores[4].Away should be equal.");
            y.Result.SetScores[4].IsTechnicalDefeat.Should().Be(x.Result.SetScores[4].IsTechnicalDefeat,
