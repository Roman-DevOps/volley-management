    ...
    public class GameResultsControllerTests
    {
        ...
        private void VerifyEditGameResult(Result expectedResult, Times times)
        {
            _gameServiceMock.Verify(
                ts => ts.EditGameResult(It.Is<Game>(g => AreResultsEqual(g.Result, expectedResult))), times);
        }
        ...
        public void CreateGetAction_GameResultViewModelRequested_GameResultViewModelIsReturned()
        {
            ...
            // Assert
            TestHelper.AreEqual(expected, actual, new GameResultViewModelComparer());
        }
        ...
        public void TournamentResults_TournamentResultsRequested_TournamentResultsReturned()
        {
            ...
            // Act
            var actual =
                TestExtensions.GetModel<TournamentResultsViewModel>(sut.TournamentResults(TOURNAMENT_ID,
                    TOURNAMENT_NAME));
