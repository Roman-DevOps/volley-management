...
namespace VolleyManagement.UnitTests.WebApi.ViewModels.Schedule
{
    ...
    {
        public static void AssertAreEqual(DivisionTitleViewModel expected, DivisionTitleViewModel actual,
            string messagePrefix = "")
        {
            ...
            actual.Rounds.Count.Should().Be(expected.Rounds.Count,
                $"{messagePrefix}Number of Round entries does not match.");
